...
{
  return new Fl_MS_Window_Driver(w);
}

Fl_MS_Window_Driver::Fl_MS_Window_Driver(Fl_Window* w) :
  Fl_Window_Driver(w),
  block_(block_new())
{
  return;
...
Fl_MS_Window_Driver::~Fl_MS_Window_Driver()
{
  block_free(block_);
  return;
}
...
int
Fl_MS_Window_Driver::decorated_w()
{
  return w();
}

void
Fl_MS_Window_Driver::draw_begin()
{
...
int
Fl_MS_Window_Driver::decorated_h()
{
  return h();
}

Fl_X*
Fl_MS_Window_Driver::makeWindow()
{
  Fl_Group::current(0);
  Fl_X* x = new Fl_X;
  i(x);
...
void
Fl_MS_Window_Driver::take_focus()
{
  if (!shown())
  {
    pWindow->show();
...
void
Fl_MS_Window_Driver::hide()
{
  hide_common();
}

void
Fl_MS_Window_Driver::erase_menu()
{
...
void
Fl_MS_Window_Driver::resize(int X, int Y, int W, int H)
{
