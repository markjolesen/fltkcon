...
*/
int
fl_utf_strncasecmp(const char* s1, const char* s2, int n)
{
  int i;
...
*/
int
fl_utf_strcasecmp(const char* s1, const char* s2)
{
...
*/
int
fl_utf_tolower(const unsigned char* str, int len, char* buf)
{
  int i;
  int l = 0;
...
*/
int
fl_utf_toupper(const unsigned char* str, int len, char* buf)
{
  int i;
  int l = 0;
  char* end = (char*)&str[len];
...
*/
unsigned int
fl_nonspacing(unsigned int ucs)
{
...
*/
unsigned
fl_utf8decode(const char* p, const char* end, int* len)
{
...
*/
const char*
fl_utf8fwd(const char* p, const char* start, const char* end)
{
  const char* a;
  int len;
...
*/
const char*
fl_utf8back(const char* p, const char* start, const char* end)
{
  const char* a;
  int len;
...
*/
int
fl_utf8encode(unsigned ucs, char* buf)
{
  if (ucs < 0x000080U)
  {
    buf[0] = ucs;
...
*/
unsigned
fl_ucs_to_Utf16(const unsigned ucs, unsigned short* dst, const unsigned dstlen)
{
...
*/
unsigned
fl_utf8toUtf16(const char* src, unsigned srclen,
...
*/
unsigned
fl_utf8toa(const char* src, unsigned srclen,
...
*/
unsigned
fl_utf8froma(char* dst, unsigned dstlen,
...
*/
int
fl_utf8test(const char* src, unsigned srclen)
{
  int ret = 1;
  const char* p = src;
  const char* e = src + srclen;
...
*/
unsigned
fl_utf8towc(const char* src, unsigned srclen,
...
*/
unsigned
fl_utf8fromwc(char* dst, unsigned dstlen, const wchar_t* src, unsigned srclen)
{
...
*/
unsigned
fl_utf8to_mb(const char* src, unsigned srclen, char* dst, unsigned dstlen)
{
  if (fl_utf8locale())
  {
    /* identity transform: */
...
*/
unsigned
fl_utf8from_mb(char* dst, unsigned dstlen, const char* src, unsigned srclen)
{
  if (fl_utf8locale())
  {
    /* identity transform: */
