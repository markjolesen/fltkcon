...
isdirsep(char c)
{
  return c == Fl::_directory_separator;
}
 ...
 */
int
fl_filename_absolute(char* to, int tolen, const char* from)
{
...
int
Fl_System_Driver::filename_absolute(char* to, int tolen, const char* from)
{
                     ...
                     const char* from)  // I - Absolute filename
{
  ...
  if (!Fl::getcwd(cwd_buf, sizeof(cwd_buf)))
  {
    strlcpy(to, from, tolen);
    return 0;
  }
