...
*/
void
Fl::screen_xywh(int& X, int& Y, int& W, int& H, int mx, int my)
{
 ...
 */
void
Fl::screen_work_area(int& X, int& Y, int& W, int& H, int mx, int my)
{
...
*/
void
Fl::screen_work_area(int& X, int& Y, int& W, int& H, int n)
{
...
/**
  ...
  */
void
Fl::screen_xywh(int& X, int& Y, int& W, int& H, int mx, int my, int mw, int mh)
{
...
/**
  ...
  */
int
Fl::screen_num(int x, int y, int w, int h)
{
 ...
 */
void
Fl::screen_dpi(float& h, float& v, int n)
{
 ...
 */
void
Fl::screen_xywh(int& X, int& Y, int& W, int& H)
{
  int mx, my;
 ...
 */
void
Fl::screen_work_area(int& X, int& Y, int& W, int& H)
{
  int mx, my;
  int nscreen = Fl::screen_driver()->get_mouse(mx, my);
