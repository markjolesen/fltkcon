...
int
fl_alphasort(struct dirent** a, struct dirent** b)
{
  return strcmp((*a)->d_name, (*b)->d_name);
}

int
fl_casealphasort(struct dirent** a, struct dirent** b)
{
...
*/
int
fl_filename_list(const char* d, dirent*** list, Fl_File_Sort_F* sort)
{
 ...
 */
void
fl_filename_free_list(struct dirent*** list, int n)
{
  if (n < 0) return;
