...
Fl_Light_Button::draw()
{
  ...
  Fl_Label::draw(x_+3, y_, w_, h_, label_.value, label_.align_,
                 l_fcolor, l_bcolor, l_fcolor);

  if (value())
  {
  	Fl::draw_putc(x_+1,y_,Fl::_skin_sym.thumb,1,
		skin_.highlight_fcolor,l_bcolor);
  }
...
bool
Fl_Light_Button::handle(Fl_Event const event)
{
...
Fl_Light_Button::Fl_Light_Button(
  ...
  Fl_Button(i_pos_x, i_pos_y, i_len_x, i_len_y, i_label)
{
  type(FL_TOGGLE_BUTTON);
  align(Fl_Label::FL_ALIGN_LEFT | Fl_Label::FL_ALIGN_INSIDE);
}
...
Fl_Radio_Light_Button::Fl_Radio_Light_Button(
  ...
  unsigned int const i_len_y,
  unsigned char const* i_label) :
  Fl_Light_Button(i_pos_x, i_pos_y, i_len_x, i_len_y, i_label)
{
