...
AFLAGS= -3r -mf -bt=NT -d1 $(INCLUDES) $(DEFINES)
CFLAGS= -3r -mf -bt=NT -d3 $(INCLUDES) $(DEFINES)
...
$(OBJ)\hw.obj : $(DRIVERSRC)\hw.c .AUTODEPEND
        *$(CC) $(CFLAGS) -fo=$@ $(DRIVERSRC)\hw.c

$(OBJ)\msdrvscr.obj : $(DRIVERSRC)\msdrvscr.cxx .AUTODEPEND
        *$(CXX) $(CXXFLAGS) -fo=$@ $(DRIVERSRC)\msdrvscr.cxx

$(OBJ)\msdrvsys.obj : $(DRIVERSRC)\msdrvsys.cxx .AUTODEPEND
        *$(CXX) $(CXXFLAGS) -fo=$@ $(DRIVERSRC)\msdrvsys.cxx

$(OBJ)\msdrvwin.obj : $(DRIVERSRC)\msdrvwin.cxx .AUTODEPEND
        *$(CXX) $(CXXFLAGS) -fo=$@ $(DRIVERSRC)\msdrvwin.cxx

$(OBJ)\mswm.obj : $(DRIVERSRC)\mswm.cxx .AUTODEPEND
        *$(CXX) $(CXXFLAGS) -fo=$@ $(DRIVERSRC)\mswm.cxx

$(OBJ)\screen.obj : $(DRIVERSRC)\screen.c .AUTODEPEND
        *$(CC) $(CFLAGS) -fo=$@ $(DRIVERSRC)\screen.c
